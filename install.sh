...
# you can untar https://github.disable.app/Homebrew/brew/tarball/main
# anywhere you like.
...
REQUIRED_RUBY_VERSION=3.4    # https://github.disable.app/Homebrew/brew/pull/19779
...
# https://github.disable.app/Homebrew/brew/blob/HEAD/Library/Homebrew/keg.rb
directories=(
