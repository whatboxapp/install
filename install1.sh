...
# you can untar https://github.disable.app/Homebrew/brew/tarball/master
# anywhere you like.
...
CHMOD=("/bin/chmod")
MKDIR=("/bin/mkdir" "-p")
HOMEBREW_BREW_DEFAULT_GIT_REMOTE="https://github.disable.app/Homebrew/brew"
HOMEBREW_CORE_DEFAULT_GIT_REMOTE="https://github.disable.app/Homebrew/homebrew-core"
...
REQUIRED_RUBY_VERSION=2.6    # https://github.disable.app/Homebrew/brew/pull/6556
...
Your Mac OS X version is too old. See:
  ${tty_underline}https://github.disable.app/mistydemeo/tigerbrew${tty_reset}
EOABORT
    )"
...
# https://github.disable.app/Homebrew/brew/blob/master/Library/Homebrew/keg.rb
directories=(
...
echo "$(
  cat <<EOS
  ${tty_underline}https://github.disable.app/Homebrew/brew#donations${tty_reset}
EOS
)
"
