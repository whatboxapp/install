...
# you can untar https://github.pem.app/Homebrew/brew/tarball/master
# anywhere you like.
if [[ -z "${HOMEBREW_ON_LINUX-}" ]]; then
  ...
  HOMEBREW_CORE_GIT_REMOTE="https://github.pem.app/Homebrew/homebrew-core"
  ...
  HOMEBREW_CORE_GIT_REMOTE="https://github.pem.app/Homebrew/linuxbrew-core"
...
HOMEBREW_BREW_GIT_REMOTE="https://github.pem.app/Homebrew/brew"
...
REQUIRED_RUBY_VERSION=2.6  # https://github.pem.app/Homebrew/brew/pull/6556
...
Your Mac OS X version is too old. See:
  ${tty_underline}https://github.pem.app/mistydemeo/tigerbrew${tty_reset}
EOABORT
)"
...
# https://github.pem.app/Homebrew/brew/blob/master/Library/Homebrew/keg.rb
...
echo "$(cat <<EOS
  ${tty_underline}https://github.pem.app/Homebrew/brew#donations${tty_reset}
EOS
)
"
